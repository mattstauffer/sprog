...
define('CRAFT_BASE_PATH', realpath(str_replace("plugins/sprog", '', exec('pwd'))).'/');
...
// Load plugin
require_once CRAFT_PLUGINS_PATH.'sprog/SprogPlugin.php';
require_once CRAFT_PLUGINS_PATH.'sprog/vendor/autoload.php';
